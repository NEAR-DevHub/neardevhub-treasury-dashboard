...
async function test1ClickAPI() {
  ...
  console.log(
    "Testing different deadline values to see how 1Click handles them...\n"
  );
  ...
  for (const test of deadlineTests) {
    ...
    const requestPayload = {
      ...
      originAsset:
        "nep141:17208628f84f5d6ad33f0da3bbbeb27ffcb398eac501a31bd6ad2011e36133a1", // NEAR USDC
      depositType: "INTENTS",
    ...
    try {
      ...
      console.log(
        `⏰ Actual deadline: ~${diffHours.toFixed(1)} hours from now`
      );
