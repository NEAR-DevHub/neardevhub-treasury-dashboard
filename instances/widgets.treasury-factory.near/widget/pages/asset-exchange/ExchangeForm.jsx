...
const code = `
      ...
      <div class="d-flex">
          ...
          <div class="token-selector">
              ...
              <div id="sendDropdownMenu" class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start px-2">
                  <input id="sendSearchInput" type="text" class="form-control mb-2" placeholder="Search token" onkeyup="handleSendSearch(event)" />
                  <div id="sendScrollBox" class="scroll-box"></div>
              </div>
          </div>
      </div>
  </div>
      ...
      <div class="d-flex">
          ...
          <div class="token-selector">
              ...
              <div id="receiveDropdownMenu" class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start px-2">
                  <input id="receiveSearchInput" type="text" class="form-control mb-2" placeholder="Search token" onkeyup="handleReceiveSearch(event)" />
                  <div id="receiveScrollBox" class="scroll-box"></div>
              </div>
          </div>
      </div>
  ...
  The treasury balance doesn't have enough tokens to swap. You can create the request, but it won’t be approved until the balance is topped up.</div>
  ...
  <i class="bi bi-info-circle h5 mb-0"></i><div>
  To exchange NEAR for another token, first swap it for wNEAR. You can then exchange wNEAR for your desired token</div>
  </div>
  </div>
      ...
      <script>
          ...
          async function fetchTokens() {
              try {
                  ...
                  document.getElementById("swap-error").innerText = "Failed to load tokens.";
