...
test.describe("Have valid staked requests and sufficient token balance", function () {
  ...
  test.describe("Admin connected", function () {
    ...
    test("Should create unstake delegation request, should throw error when invalid data is provided, should show in table after submission", async ({
      ...
      const description =
        "* Proposal Action: withdraw <br>* Show After Proposal Id Approved: 2 <br>* Custom Notes: Following to [#2](/treasury-devdao.near/widget/app?page=stake-delegation&id=2) unstake request <br>* Amount: 300000000000000000000000";
